...
function StatisticsPage({ userRole, token }) {
  ...
  useEffect(() => {
    ...
    Promise.all([
      authFetch(`${API_BASE}/stats/water-level${qs}`,       { headers }).then(r => r.json()),
      authFetch(`${API_BASE}/stats/status-breakdown${qs}`,  { headers }).then(r => r.json()),
      authFetch(`${API_BASE}/stats/uptime${qs}`,            { headers }).then(r => r.json()),
      authFetch(`${API_BASE}/stats/water-level${qsP}`,      { headers }).then(r => r.json()),
      authFetch(`${API_BASE}/stats/status-breakdown${qsP}`, { headers }).then(r => r.json()),
      authFetch(`${API_BASE}/stats/uptime${qsP}`,           { headers }).then(r => r.json()),
      ...
      if (e?.message !== "Unauthorized" && !cancelled) setError(true);
