...
// ─── FEWS BASE DATA ───────────────────────────────────────────────────────────
const FEWS1_BASE = {
  id: 1, name: "FEWS 1", location: "Calumpang Bridge",
  lat: 13.7547568, lng: 121.0628477,
            ...
            <main className="content">
              <div className="card card-map" style={{ position: "relative" }}>
                ...
                <div className="map-wrap">
                  ...
                  <MapContainer center={[13.7547568, 121.0628477]} zoom={15}
            ...
            <div className="map-fullscreen-overlay" onClick={() => { setFullscreenMap(false); setFsSelectedFEWS(null); }}>
              <div className="map-fullscreen-box" onClick={e => e.stopPropagation()}>
                <div className="map-fullscreen-inner">
                  ...
                  <MapContainer center={[13.7547568, 121.0628477]} zoom={15} style={{ height:"100%", width:"100%" }} scrollWheelZoom={true}>
                    ...
                    return (
                      <div className="map-fs-station">
                        ...
                        <div className="map-fs-row">
                          ...
                          <span className="map-fs-row-val">Calumpang Bridge, Batangas</span>
                        </div>
                        <div className="map-fs-row">
