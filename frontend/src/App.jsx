...
const ALL_NAV_ITEMS = [
  ...
  { key: "Statistics",  icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="3" y1="20" x2="21" y2="20"/><rect x="6" y="13" width="4" height="7"/><rect x="14" y="7" width="4" height="13"/></svg>, label: "Statistics"    }, 
