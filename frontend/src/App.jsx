...
const waterChartOptions = useMemo(() => ({
    ...
    plugins: {
      ...
      annotation: {
        annotations: {
          zoneSafe:    { type: "box", yMin: 0,                    yMax: thresholds.warning, backgroundColor: "rgba(34,197,94,0.50)",  borderWidth: 0 },
          zoneWarning: { type: "box", yMin: thresholds.warning,   yMax: thresholds.danger,  backgroundColor: "rgba(245,158,11,0.50)", borderWidth: 0 },
          zoneCritical:{ type: "box", yMin: thresholds.danger,    yMax: 500,                backgroundColor: "rgba(239,68,68,0.50)",  borderWidth: 0 },
             ...
             {/* ─── ALARM STATUS ─── */}
              {(() => {
                const ALARM_CFG = {
                  safe: {
                    color:  "#22c55e",
                    bg:     "rgba(34,197,94,0.50)",
                    border: "rgba(34,197,94,0.60)",
                    sqBg:   "rgba(34,197,94,0.55)",
                    sqBor:  "rgba(34,197,94,0.70)",
                    label:  "ALL CLEAR",
                    icon:   "✓",
                    anim:   false,
                  },
                  warning: {
                    color:  "#f59e0b",
                    bg:     "rgba(245,158,11,0.50)",
                    border: "rgba(245,158,11,0.60)",
                    sqBg:   "rgba(245,158,11,0.55)",
                    sqBor:  "rgba(245,158,11,0.70)",
                    label:  "WARNING",
                    icon:   "!",
                    anim:   true,
                  },
                  danger: {
                    ...
                    sqBg:   "rgba(239,68,68,0.55)",
                    sqBor:  "rgba(239,68,68,0.70)",
                    label:  "CRITICAL",
                    icon:   "!!",
                    anim:   true,
                  },
