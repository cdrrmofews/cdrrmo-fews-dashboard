                        ...
                        <Marker key={f.id} position={[f.lat, f.lng]} icon={icon}
                          ...
                          <Popup minWidth={200} maxWidth={280}>
                            <div style={{ fontFamily:"sans-serif", padding:"2px 0" }}>
                              ...
                              }} style={{ marginTop:"7px", padding:"3px 8px", background: copiedId===f.id?"#38bdf8":markerColor, color:"#ffffff", border:"none", outline:"none", boxShadow:"none", borderRadius:"4px", cursor:"pointer", fontWeight:"700", fontSize:"10px", width:"auto", display:"block", margin:"7px auto 0", transition:"background 0.2s" }}>
