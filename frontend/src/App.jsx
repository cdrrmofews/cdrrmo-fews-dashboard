              ...
              {(() => {
                const ALARM_CFG = {
                  safe: {
                    ...
                    sqBg:   "rgba(34,197,94,0.35)",
                    sqBor:  "rgba(34,197,94,0.50)",
                    label:  "ALL CLEAR",
                    icon:   "✓",
                    anim:   false,
                  },
                  warning: {
                    ...
                    sqBg:   "rgba(245,158,11,0.35)",
                    sqBor:  "rgba(245,158,11,0.50)",
                    label:  "WARNING",
                    icon:   "!",
                    anim:   true,
                  },
                  danger: {
                    ...
                    sqBg:   "rgba(239,68,68,0.35)",
                    sqBor:  "rgba(239,68,68,0.50)",
                    label:  "CRITICAL",
                    icon:   "!!",
                    anim:   true,
                  },
                  offline: {
                    color:    "#9facbe",
                    bg:       "rgba(74,96,126,0.30)",
                    border:   "rgba(74,96,126,0.40)",
                    sqBg:     "rgba(74,96,126,0.35)",
                    sqBor:    "rgba(74,96,126,0.50)",
                    label:    "OFFLINE",
                    icon:     "◌",
                    anim:     false,
                    iconFont: "sans-serif",
